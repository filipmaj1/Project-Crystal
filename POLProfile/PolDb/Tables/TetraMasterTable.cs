...
{
    public class TetraMasterTable() : PolDbTable(2, "poldb_tetramaster", [
            ...
            new("z_attrstr", "averageRank", Datatype.STRINGS, 0x40),
            new("z_attrsl0", "jobLevel", Datatype.ULONG64),
            ...
            new("z_attrsi0", "cardLevel", Datatype.INT32),
            ...
            new("z_attrss0", "currentTitle", Datatype.SHORT16),
